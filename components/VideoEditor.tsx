...
import { Play, Pause, SkipBack, SkipForward, ZoomIn, ZoomOut, Scissors, Download, AlertCircle, Film, Image as ImageIcon, X } from 'lucide-react';
...
export const VideoEditor: React.FC<VideoEditorProps> = ({ segments, labels, onRemoveSegment }) => {
              ...
              >
                ...
                {onRemoveSegment && (
                  <button
                    ...
                    className="absolute top-1 left-1 p-1 bg-red-500 text-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity z-20 hover:bg-red-600 shadow-lg"
